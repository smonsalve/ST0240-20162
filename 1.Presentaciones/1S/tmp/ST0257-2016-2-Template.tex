%**************************************************************************
%   Mecanica Aplicada, Universidad EAFIT
%   Plantilla para presentaciones
%   Manuel Garcia
%   Agosto 2012
%   Actualizacion 2015
%**************************************************************************
%% Fundamentos de Programación para Finanzas
...
%\PassOptionsToPackage{table}{xcolor}     % This line produces 100 errors.
\documentclass[xcolor=svgnames]{beamer} 
\usefonttheme[onlymath]{serif}

% Choose the encoding for the file
...
\logo{\includegraphics[width=1.5cm]{logoEAFIT2015}\vspace{-.2cm}} 
...
\title[Sistemas Operativos]{ST--257 Sistemas Operativos }
\author{Juan David Pineda Cárdenas \\ \textless jpineda2@eafit.edu.co\textgreater \newline \newline Juan F. Cardona Mc'Cormick \\ \textless fcardona@eafit.edu.co\textgreater}
\institute{
